...
const NftCreate: NextPage = () => {
  ...
  const handleAttributeChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    const attributes = [...nftMeta.attributes];
    attributes[attributeIdx].value = value;

    setNftMeta({ ...nftMeta, attributes });
  };
  ...
  const createNft = async () => {
    try {
      ...
      const tx = contract?.mintToken(nftURI, ethers.parseEther(price), {
                      ...
                      <div>
                        ...
                        <div className="mt-1 flex rounded-md shadow-sm">
                          <input
                            ...
                            name="uri"
                            id="uri"
                            className="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full py-1.5 pl-3 rounded-md sm:text-sm border border-gray-300"
                    ...
                    <div>
                      ...
                      <div className="mt-1 flex rounded-md shadow-sm">
                        <input
                          ...
                          name="name"
                          id="name"
                          className="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full py-1.5 pl-3 rounded-md sm:text-sm border-gray-300 border"
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <textarea
                          ...
                          name="description"
                          rows={3}
                          className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 py-1.5 pl-3 block w-full sm:text-sm border border-gray-300 rounded-md"
                      ...
                      {nftMeta.attributes.map((attribute) => (
                        ...
                        >
                          ...
                          <input
                            ...
                            className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full py-1.5 pl-3 shadow-sm sm:text-sm border border-gray-300 rounded-md"
                          />
                        </div>
                      ))}
                    </div>
